...
export default function Drawer({ handleDrawerToggle }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <NavLink to="/" onClick={() => handleDrawerToggle()} className="menu-item">{(location.pathname === "/") ? (
          <Scribble>Home</Scribble>
        ) : (
          <p>Home</p>
        )}
        </NavLink>
        <NavHashLink to="/#portfolio" onClick={() => handleDrawerToggle()} className="menu-item">Portfolio</NavHashLink>
        <NavLink to="/about" onClick={() => handleDrawerToggle()} className="menu-item">{(location.pathname === "/about") ? (
