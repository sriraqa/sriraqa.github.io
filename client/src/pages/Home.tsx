...
export default function Home() {
  return (
    <div className="flex flex-col space-y-32 pb-20 w-full min-[930px]:px-28 sm:px-16 items-center">
      {/* Header */}
      <div className="pt-12 min-[833px]:pt-28 flex flex-col-reverse min-[833px]:flex-row md:space-x-8 items-center mx-auto">
        ...
        <img className="h-[200px] mb-10" src={illustration}/>
      </div>
